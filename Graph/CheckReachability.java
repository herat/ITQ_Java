...
public class CheckReachability {
    ...
    static boolean DFS_Detect_Cycle(WeightedNode startNode, ArrayList<WeightedNode> visited, WeightedNode destination) {
...
//            System.out.println(startNode.label);
            ...
            if(!startNode.adjacencyList.isEmpty()) {
                for(WeightedNode n : startNode.adjacencyList.keySet()) {
                    ...
                    DFS_Detect_Cycle(n,visited,destination);
                }
            }
        }
        return decision;
    ...
    public static void main(String[] args) {
        ...
        if(DFS_Detect_Cycle(node1,new ArrayList<WeightedNode>(),node8)) {
            System.out.println("Reachable node.");
        } else {
            System.out.println("Not reachable node.");
        }
    }    
}
